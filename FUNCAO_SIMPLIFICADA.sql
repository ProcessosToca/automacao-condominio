...
-- Função simplificada para buscar usuário por ID
...
-- Função simplificada para atualizar usuário
...
AND routine_name IN ('get_all_users', 'get_user_by_id', 'update_user_by_admin');
