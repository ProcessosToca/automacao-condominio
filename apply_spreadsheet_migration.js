// Script para aplicar a migração da tabela spreadsheet_data
const fetch = (...args) => import('node-fetch').then(({default: fetch}) => fetch(...args));

async function applySpreadsheetMigration() {
  console.log('🚀 Aplicando migração da tabela spreadsheet_data...\n');
...
CREATE TRIGGER trigger_update_spreadsheet_data_updated_at
  ...
  EXECUTE FUNCTION public.update_spreadsheet_data_updated_at();
    ...
    console.log('=' * 80);
    console.log('\n   ✅ Após aplicar, execute: node setup_spreadsheet_system.js');
