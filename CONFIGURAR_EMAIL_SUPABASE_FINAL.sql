-- =====================================================
-- CONFIGURAR EMAIL SUPABASE COM NOVA SENHA
...
BEGIN
  ...
  -- Configurar variável para o template de email do Supabase
  -- Esta variável será usada no template HTML
...
4. Clique na aba "<> Source"
5. Substitua todo o HTML pelo conteúdo do arquivo TEMPLATE_EMAIL_RESET_PASSWORD.html
6. No campo "Subject heading", digite: "Sua Nova Senha - Sistema de Gestão"
7. Clique em "Save changes"

O template HTML já está configurado para usar a variável {{ .NewPassword }}
que será preenchida automaticamente pelo Supabase.
*/
